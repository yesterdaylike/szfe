...
public class TableView extends TextView {
	...
	private void initPositionlist(){
		int height = getHeight();	//view�ܵĸ߶�
		int width = getWidth(); 	//view�ܵĿ���

		int cellHeight = height >> 2;//С�����ĸ߶�
		int cellWidth = width >> 2;  //С�����Ŀ���

		stepIntervalH = cellHeight >> 3;//С�����ĸ߶�
		stepIntervalW = cellWidth >> 3;  //С�����Ŀ���
